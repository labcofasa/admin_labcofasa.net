                    ...
                    render: function (data, type, row) {
                        return `
                                <div class="btn-group" role="group">
                                    <button class="btn btn-warning editar-clasificacion" data-id="${row.id}" data-toggle="tooltip" title="Editar clasificación">
                                    ...
                                    <button class="btn btn-danger eliminar-clasificacion" data-id="${row.id}" data-toggle="tooltip" title="Eliminar clasificación">
