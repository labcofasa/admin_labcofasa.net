<!-- Modal para confirmar la eliminación de formularios -->
<div class="modal fade" id="eliminarFormulario" tabindex="-1" role="dialog" aria-labelledby="eliminarFormularioLabel"
    aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered custom-modal" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5 titulo" id="eliminarFormularioLabel">Confirmar eliminación</h1>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn-actions btn btn-lg btn-danger"
                    id="btn-eliminar-formulario">Eliminar</button>
            </div>
        </div>
    </div>
</div>
