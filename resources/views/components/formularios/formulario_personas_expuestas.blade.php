<div class="row">
    ...
    <div class="col-sm-6">
        <div class="mb-3">
            ...
            <div class="invalid-feedback">
                Por favor, ingrese el nombre según documento de identidad.
            </div>
        </div>
    </div>
    <div class="col-sm-6">
    ...
    <div class="col-sm-6">
        <div class="mb-3">
            ...
            <div class="invalid-feedback">
                Por favor, ingrese el período de nombramiento.
            </div>
        </div>
    </div>
    <div class="col-sm-6">
    ...
    <div class="col-sm-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" placeholder="Ejemplo: 10%"
                id="porcentaje_participacion_politico" name="porcentaje_participacion_politico"
                aria-describedby="ayuda">
            <div id="ayuda" class="form-text">
    ...
    <div class="col-sm-12">
        <div class="mb-3">
            ...
            <div class="invalid-feedback">
                Por favor, ingrese sus principales fuentes de ingresos.
            </div>
        </div>
    </div>
    <div class="col-sm-6">
