<div class="offcanvas-body">
    <ul class="navbar-nav nav-movil justify-content-start flex-grow-1 pe-3">
            ...
            <li class="nav-item">
                <a href="{{ route('dashboard') }}" class="nav-link {{ request()->routeIs('dashboard') ? 'active' : '' }}"
                    ...
                    <svg class="icon pe-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                        ...
                        <path d="M2.5 9H21.5" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round" />
                        ...
                        <path d="M12.707 15.293L11.2928 16.7072" stroke="currentColor" stroke-width="1.8"
        ...
        <li class="nav-item">
            <a href="{{ route('accesos') }}" class="nav-link {{ request()->routeIs('accesos') ? 'active' : '' }}"
                aria-current="page">
                <svg class="icon pe-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20"
        ...
        @if (auth()->user()->hasAnyPermission([
            ...
            <span class="link_name subtitle-movil pt-2 mb-1">Empleos</span>
        @endif
    ...
    <ul class="navbar-nav nav-movil justify-content-start flex-grow-1 pe-3">
        @if (auth()->user()->hasAnyPermission([
            ...
            <span class="link_name subtitle-movil pt-2 mb-1">Administración</span>
        @endif
                ...
                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                    ...
                    <svg class="icon pe-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                        ...
                        <path
                            ...
                            stroke="currentColor" stroke-width="1.8" />
                        <path d="M18.5 22L18.5 15M15 18.5H22" stroke="currentColor" stroke-width="1.8"
                ...
                <ul class="dropdown-menu">
                    <li class="nav-item dropdown">
                        <a class="dropdown-item {{ request()->routeIs('pag.usuarios') ? 'active' : '' }}"
                            ...
                            <svg class="icon pe-none me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                ...
                <a href="{{ route('pag.articulo') }}"
                    ...
                    <svg class="icon pe-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                        ...
                        <path
                            ...
                            stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M6 12L8 13" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M17 4L7 9" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"
                            stroke-linejoin="round" />
                    </svg>
