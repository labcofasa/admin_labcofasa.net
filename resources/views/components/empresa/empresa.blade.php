                        ...
                        <div class="tab-content" id="myTabContentEditar">
                            <div class="tab-pane active" id="ig-tab-pane-editar" role="tabpanel"
                                ...
                                <div class="row pt-3">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="nombre-empresa-editar" class="text-label">Nombre de la empresa
                                                <span class="obligatorio"> *</span></label>
                                            <input autocomplete="off" type="text" name="nombre" autofocus
                                        ...
                                        <div class="form-group mb-3">
                                            <label data-bs-toggle="tooltip" data-bs-custom-class="custom-tooltip"
                                                ...
                                                for="giro-empresa-editar" class="text-label">Giro <span
                                                    class="obligatorio"> *</span>
                                                <svg class="icon-btn-info" xmlns="http://www.w3.org/2000/svg"
                                                    height="24px" viewBox="0 0 24 24" width="24px"
                                                    fill="#000000">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            <label for="entidad-empresa-select-editar" class="text-label">Tipo de
                                                entidad
                                                <span class="obligatorio"> *</span>
                                            </label>
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="pais-empresa-select-editar" class="text-label">País <span
                                                    class="obligatorio"> *</span></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            <label for="depto-empresa-select-editar" class="text-label">Departamento
                                                <span class="obligatorio"> *</span></label>
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="municipio-empresa-select-editar" class="text-label">Municipio
                                                <span class="obligatorio"> *</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <label for="direccion-textarea-editar" class="text-label">Dirección de la
                                                empresa <span class="obligatorio"> *</span></label>
                            ...
                            <div class="tab-pane" id="dc-tab-pane-editar" role="tabpanel"
                                ...
                                <div class="row py-3">
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            <label for="telefono-empresa-editar" class="text-label">Teléfono</label>
                                            <input autocomplete="off" type="tel" name="telefono"
                                                pattern="^(\+\d{1,3}[\s\-]?)?(\d{1,4}[\s\-]?){2}\d{4}$" maxlength="15"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            <label for="email-empresa-editar" class="text-label">Correo
                                                electrónico</label>
                                            <input autocomplete="off" type="email" name="email"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            <label for="web-empresa-editar" class="text-label">Enlace URL del sitio
                                                web</label>
                                            <input autocomplete="off" type="url" name="web"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            <label data-bs-toggle="tooltip" data-bs-custom-class="custom-tooltip"
                                                data-bs-placement="top"
                                                data-bs-title="Número de Identificación Tributaria"
                                                for="nit-empresa-editar" class="text-label">Registro NIT
                                                <svg class="icon-btn-info" xmlns="http://www.w3.org/2000/svg"
                                                    height="24px" viewBox="0 0 24 24" width="24px"
                                                    fill="#000000">
                                                    <path d="M0 0h24v24H0V0z" fill="none" />
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            <label data-bs-toggle="tooltip" data-bs-custom-class="custom-tooltip"
                                                data-bs-placement="top"
                                                data-bs-title="Dirección Nacional de Medicamentos"
                                                for="nombre-dnm-empresa-editar" class="text-label">Nombre DNM
                                                <svg class="icon-btn-info" xmlns="http://www.w3.org/2000/svg"
                                                    height="24px" viewBox="0 0 24 24" width="24px"
                                                    fill="#000000">
                                                    <path d="M0 0h24v24H0V0z" fill="none" />
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="fundacion-empresa-editar" class="text-label">Fecha de inicio
                                                de
                                                operaciones</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            <label data-bs-toggle="tooltip" data-bs-custom-class="custom-tooltip"
                                                data-bs-placement="top"
                                                data-bs-title="Dirección Nacional de Medicamentos"
                                                for="registro-dnm-empresa-editar" class="text-label">Registro DNM
                                                <svg class="icon-btn-info" xmlns="http://www.w3.org/2000/svg"
                                                    height="24px" viewBox="0 0 24 24" width="24px"
                                                    fill="#000000">
                                                    <path d="M0 0h24v24H0V0z" fill="none" />
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="clasificacion-empresa-select-editar"
                                                class="text-label">Clasificación <span class="obligatorio">
                                                    *</span></label>
                            ...
                            <div class="tab-pane" id="dl-tab-pane-editar" role="tabpanel"
                                ...
                                <div class="row py-3">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <label for="mision-textarea-editar" class="text-label">Mision de la
                                                empresa</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <label for="vision-textarea-editar" class="text-label">Vision de la
                                                empresa</label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            <label for="calidad-textarea-editar" class="text-label">Política de
                                                calidad</label>
...
<!-- Modal para confirmar la eliminación de empresas -->
<div class="modal fade" id="eliminarEmpresa" tabindex="-1" role="dialog" aria-labelledby="eliminarEmpresaLabel"
    aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered custom-modal" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5 titulo" id="eliminarEmpresaLabel">Confirmar eliminación</h1>
                <button class="btn-icon-close" data-bs-dismiss="modal">
                    <svg class="icon-close" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24"
                        width="24px" fill="#000000">
                        <path d="M0 0h24v24H0V0z" fill="none" />
            ...
            <div class="modal-body">
                <p class="mt-3 text-center">
                    ¿Está seguro de que desea eliminar la empresa: "<span id="nombre-empresa"></span>"?
                </p>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn-actions btn btn-lg btn-danger"
                    id="btn-eliminar-empresa">Eliminar</button>
            </div>
        </div>
    </div>
</div>

<!-- Modal para confirmar la eliminación de red social -->
<div class="modal fade" id="eliminarRedSocial" tabindex="-1" role="dialog"
    aria-labelledby="eliminarRedSocialLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered custom-modal" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5 titulo" id="eliminarRedSocialLabel">Confirmar eliminación</h1>
                <button class="btn-icon-close" data-bs-dismiss="modal">
                    <svg class="icon-close" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24"
                        width="24px" fill="#000000">
                        <path d="M0 0h24v24H0V0z" fill="none" />
            ...
            <div class="modal-body">
                <p class="mt-3 text-center">
                    ¿Está seguro de que desea eliminar la red social: "<span id="nombre-red-social"></span>"?
                </p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn-actions btn btn-lg btn-secondary"
                    data-bs-dismiss="modal">Cancelar</button>
                <button type="button" class="btn-actions btn btn-lg btn-danger"
                    id="btn-eliminar-red-social">Eliminar</button>
            </div>
        </div>
    </div>
</div>
