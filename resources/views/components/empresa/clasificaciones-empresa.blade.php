        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="tabla-clasificaciones-container" style="display: none;">
                    <table id="tabla-clasificaciones" class="table table-sm align-middle responsive display" width="100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Nombre</th>
...
<!-- Modal para crear clasificaciones -->
<div class="modal fade" id="crearClasificacion" tabindex="-1" role="dialog" aria-labelledby="crearClasificacionLabel"
    aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered custom-modal" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5 titulo" id="crearClasificacionLabel">Crear clasificación</h1>
                <button class="btn-icon-close" data-bs-dismiss="modal">
                    <svg class="icon-close" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24"
                        width="24px" fill="#000000">
                        <path d="M0 0h24v24H0V0z" fill="none" />
            ...
            <form id="clasificacionForm" class="form needs-validation" method="POST">
                @csrf
                @method('POST')
                <div class="modal-body">
                    <div class="form-group mb-3">
                        <label for="clasificacion-nombre-input" class="text-label">Nombre <span class="obligatorio">
                                *</span></label>
                        <input autocomplete="off" type="text" name="nombre" class="form-control"
                            id="clasificacion-nombre-input" required>
                    </div>
                    <div class="form-group mb-3">
                        <label for="clasificacion-codigo" class="text-label">Código</label>
                        <input autocomplete="off" type="text" name="codigo" class="form-control"
                            id="clasificacion-codigo" required>
                    </div>
                </div>
...
<div class="modal fade" id="editarClasificacion" tabindex="-1" role="dialog"
    aria-labelledby="editarClasificacionLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered custom-modal" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
<!-- Modal para confirmar la eliminación de clasificaciones -->
<div class="modal fade" id="eliminarClasificacion" tabindex="-1" role="dialog"
    aria-labelledby="eliminarClasificacionLabel" aria-hidden="true" data-bs-backdrop="static"
    data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered custom-modal" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5 titulo" id="eliminarClasificacionLabel">Confirmar eliminación</h1>
                <button class="btn-icon-close" data-bs-dismiss="modal">
                    <svg class="icon-close" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24"
                        width="24px" fill="#000000">
                        <path d="M0 0h24v24H0V0z" fill="none" />
            ...
            <div class="modal-body">
                <p class="mt-3 text-center">
                    ¿Está seguro de que desea eliminar la clasificación: "<span id="nombre-clasificacion"></span>"?
                </p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn-actions btn btn-lg btn-secondary"
                ...
                <button type="button" class="btn-actions btn btn-lg btn-danger"
                    id="btn-eliminar-clasificacion">Eliminar</button>
            </div>
        </div>
    </div>
</div>
