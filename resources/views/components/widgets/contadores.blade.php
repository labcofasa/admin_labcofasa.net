<div class="row pb-2">
    <div class="col-md-3">
        <div class="row align-items-center card-counter info justify-content-evenly">
            <div class="col-3 px-1">
                <svg class="counter-icono" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
            ...
            <div class="col-7">
                <span class="count-name">Total de usuarios:</span>
                <span class="count-numbers" id="totalUsuarios"></span>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="row align-items-center card-counter success justify-content-evenly">
            <div class="col-3 px-1">
                <svg class="counter-icono" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24"
            ...
            <div class="col-7">
                <span class="count-name">Registrados este mes:</span>
                <span class="count-numbers" id="usuarioMes"></span>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="row align-items-center card-counter danger justify-content-evenly">
            <div class="col-3 px-1">
                <svg class="counter-icono" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
                    height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">
                    <g>
            ...
            <div class="col-7">
                <span class="count-name">Roles registrados:</span>
                <span class="count-numbers" id="totalRoles"></span>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="row align-items-center card-counter primary justify-content-evenly">
            <div class="col-3 px-1">
                <svg class="counter-icono" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
                    height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">
                    <g>
            ...
            <div class="col-7">
                <span class="count-name">Permisos registrados:</span>
                <span class="count-numbers" id="totalPermisos"></span>
            </div>
        </div>
    </div>
</div>
