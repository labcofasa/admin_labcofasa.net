<div class="container-fluid px-0 pb-3">
    <div class="container-counters">
        <div class="cards carta-primary">
            <div class="counter">
                <div class="text">
                    <p class="mb-0 link_name counter-text">Total de usuarios</p>
                    <h1 class="font-weight-bolder counter-text" id="totalUsuarios">
                    </h1>
                </div>
                <svg class="d-none d-xl-block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="75"
                    height="75" color="#000000" fill="none">
                    <path
        ...
        <div class="cards carta-danger">
            <div class="counter">
                <div class="text">
                    <p class="mb-0 link_name counter-text">En el último mes</p>
                    <h1 class="font-weight-bolder counter-text" id="usuarioMes"></h1>
                </div>
        ...
        <div class="cards carta-warning">
            <div class="counter">
                <div class="text">
                    <p class="mb-0 link_name counter-text">Roles registrados</p>
                    <h1 class="font-weight-bolder counter-text" id="totalRoles"></h1>
                </div>
                <svg class="d-none d-xl-block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="75"
                    height="75" color="#000000" fill="none">
                    <path
                    ...
                    <path
                        ...
                        stroke="currentColor" stroke-width="1.5" />
                    <path d="M4 15C4 18.3171 6.68286 21 10 21L9.14286 19.2857" stroke="currentColor" stroke-width="1.5"
                        stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M20 9C20 5.68286 17.3171 3 14 3L14.8571 4.71429" stroke="currentColor" stroke-width="1.5"
                        stroke-linecap="round" stroke-linejoin="round" />
                    <path
        ...
        <div class="cards carta-success">
            <div class="counter">
                <div class="text">
                    <p class="mb-0 link_name counter-text">Permisos para roles</p>
                    <h1 class="font-weight-bolder counter-text" id="totalPermisos"></h1>
                </div>
                <svg class="d-none d-xl-block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="75"
                    height="75" color="#000000" fill="none">
                    <path
