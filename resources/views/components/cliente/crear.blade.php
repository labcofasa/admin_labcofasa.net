...
<div class="modal fade" id="crearCliente" tabindex="-1" role="dialog" aria-labelledby="crearClienteLabel"
    aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered custom-modal modal-fullscreen-md-down" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5 titulo" id="crearClienteLabel">Registrar cliente</h1>
            ...
            <form id="clienteForm" class="form needs-validation" novalidate method="POST">
                @csrf
                @method('POST')
