        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="tabla-asignar-permisos-container" style="display: none;">
                    <table id="tabla-asignar-permisos" class="table table-sm align-middle responsive display"
                        width="100%">
                        <thead>
                            <tr>
                                <th></th>
...
<div class="modal fade" id="asignarPermisoMasa" tabindex="-1" role="dialog" aria-labelledby="asignarPermisoMasaLabel"
    aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered custom-modal" role="document">
        <div class="modal-content">
            <div class="modal-header">
