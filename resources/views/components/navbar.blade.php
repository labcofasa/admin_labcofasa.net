        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar2"
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-start flex-grow-1 pe-3">
                    ...
                    @endcan
                    @can('admin_publicidades_ver')
                        <li class="nav-item">
                            <a href="{{ route('pag.publicidad') }}"
                                class="nav-link {{ request()->routeIs('pag.publicidad') ? 'active' : '' }}">
                                <svg class="icon pe-none" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
                                    <path d="M0 0h24v24H0V0z" fill="none" />
