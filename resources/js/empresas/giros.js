                        ...
                        return `
                                <div class="btn-toolbar">
                                    <div class="btn-group" role="group">
                                        <button class="btn btn-warning editar-giro" data-id="${row.id}" data-toggle="tooltip" title="Editar giro">
                                        ...
                                        <button class="btn btn-danger eliminar-giro" data-id="${row.id}" data-toggle="tooltip" title="Eliminar giro">
