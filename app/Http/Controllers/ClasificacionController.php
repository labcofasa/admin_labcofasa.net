...
class ClasificacionController extends Controller
{
    ...
    public function tablaClasificaciones(Request $request)
    {
        ...
        $query = Clasificacion::select('clasificaciones.*', 'users.name as user_name', 'modified_users.name as user_modified_name')
            ->leftJoin('users', 'clasificaciones.user_id', '=', 'users.id')
            ->leftJoin('users as modified_users', 'clasificaciones.user_modified_id', '=', 'modified_users.id');
